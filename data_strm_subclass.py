...
def run_sim_bag(filename, k, methods=['AdaOja', 'HPCA', 'SPM', 'RMSProp'], b0=1e-5, p=None, B=10, m=1, gamma=.9, beta_1 = 0.1, beta_2 = 0.999, delta=1e-8, eta=1e-3, Sparse=True, Acc=True, X=None, xnorm2=None, num_acc=100, Time=True, bias_correction=False, b0_dim=1):
    '''
...
def run_sim_fullX(X, k, methods=['AdaOja', 'HPCA', 'SPM'], b0=1e-5, gamma=.9, beta_1 = 0.1, beta_2 = 0.999, eta=1e-3, delta=1e-8, p=None, B=10, m=1, Sparse=True, Acc=True, xnorm2=None, num_acc=100, Time=True, num_samples=None, bias_correction=False, b0_dim=1):
    '''
...
def run_sim_blocklist(Xlist, k, methods=['AdaOja', 'HPCA', 'SPM'], b0=1e-5, gamma=.9, beta_1 = 0.1, beta_2 = 0.999, eta=1e-3, delta=1e-8, bias_correction=False, b0_dim=1, p=None, m=1, Sparse=True, Acc=True, xnorm2=None, num_acc=100, Time=True):
    '''
